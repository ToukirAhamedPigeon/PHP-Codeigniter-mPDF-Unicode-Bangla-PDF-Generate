...
<body>
<h1>Hello World!</h1>
<p style="font-family: solaimanlipi; text-align: justify; background-image: url('assets/logo.png'); background-repeat: no-repeat; background-position: center center; background-opacity">
	Hello World!
